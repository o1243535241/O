...
О також простий ключ до правди, все що по ознакам О являєтся О це правда все що навпаки ні, просто напрклад О між багато і ніяк - локанічність == правда локанічна, і так далі перебираются всі слова(словника) балансу\О і провіряются, виходить баланс слів всіх слів це як О\все дзеркало в якого треба питати, цей ключ до правди також ключ до життя\інтелекту, тойсь можна любий текст брутфорсом згенерувати і провірити по цьому алгоритму на правду
