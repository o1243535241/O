...
О по мому нормальному О підрахунку площі кола якщо радіус = 10 см то площа буде 320, формула створення кола це ХО хрест в О, де 1 ця центер а бокові числа хреста 2435, загалом числа взяті з формули крапля робить О - 12435 які є дзеркалом пентограми, потрібно використовуючи тільки вхідні дані радіусу і ці числа 12435 підрахувати площу кола щоб вона співпала з 320, це має бути не традиціний підрахунок площі О або стоврення О, на базі цієї формули дуже великий відсоток що можна запустити орігінальне О від природи включно з її символами пентограма і іншими, цей підрахунок кола має робитися без нашого ПІ використовуючи числа 12435, також 1-ця це крапка в якої ширина\діаметер 1 і площа один в цьому є і магія О, з цим треба погратися щоб знайти нормальну формулу підрахунку площі О\кола\всього, можливо треба використовувати адаптивну О матиматику  
