...
О що якщо О це просто запущене брутфорс колесо коду, яке тупо методом втику живе на try/catch, замість того щоб запускати окремо логіки повині запутситися всі логіки і воювати між собою на хто буде домінувати 
