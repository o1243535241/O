...
О брутфорс О пошук\розробка О ми можемо згенерувати всі можливі коди і провірити їх на ознаки чату, потім загрузити в них словник і потім задати їм логічну просту задачку де вони мають дати відповідь якимось ключевим словом, якщо буде правильна відповідь то це схоже на інтелект, ми просто чатам які можуть бути О робимо провірку на логічність, ще щось такого треба придумати тому що О брутфорс і локанічне просте, тойсь запуск О має бути десь в початках, типу можна загнати текст у всі чати "Відпиши слово розумію якщо ти розумієш те що я пишу" що і буде провіркою на інтелект
